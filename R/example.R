...
#                           maxAlertSteps    = 100,       lookSteps = 1, kSteps = 10,
#                           waitWidths       = seq(0.15, 0.6, by = 0.05),
...
#
# system.time(amShifted <- locationShift(am, shiftedThetas = c(seq(-0.6,-0.1,by=0.05))))
#
#
# # Unrestricted Sample Size
# # Explore wait width (first with alert k specified at 50)
# plot(amShifted, "n",                 alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,801),    maxVary = 10)
# plot(amShifted, "n",                 alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,801),    maxVary = 5)
# plot(amShifted, "rejPN",             alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 10)
# plot(amShifted, "rejPN",             alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
# plot(amShifted, "bias",              alertK = 50,      xlim=c(-1,0.4),   ylim=c(-0.1,0.1), maxVary = 5)
# plot(amShifted, "mse",               alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,0.1),    maxVary = 5)
# plot(amShifted, "cover",             alertK = 50,      xlim=c(-1,0.4),   ylim=c(0.75,1),   maxVary = 5)
# plot(amShifted, "stopInconclusive",  alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
# plot(amShifted, "stopNotImpactful",  alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
# plot(amShifted, "stopNotTrivial",    alertK = 50,      xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
#
# # Explore number of steps in affirmation step
# plot(amShifted, "n",                 waitWidth = 0.35,  xlim=c(-1,0.4),   ylim=c(0,801),    maxVary = 5)
# plot(amShifted, "bias",              waitWidth = 0.3,  xlim=c(-1,0.4),   ylim=c(-0.1,0.1), maxVary = 5)
# plot(amShifted, "mse",               waitWidth = 0.3,  xlim=c(-1,0.4),   ylim=c(0,0.1),    maxVary = 5)
# plot(amShifted, "cover",             waitWidth = 0.3,  xlim=c(-1,0.4),   ylim=c(0.75,1),   maxVary = 5)
# plot(amShifted, "stopInconclusive",  waitWidth = 0.3,  xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
# plot(amShifted, "stopNotImpactful",  waitWidth = 0.3,  xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
# plot(amShifted, "stopNotTrivial",    waitWidth = 0.3,  xlim=c(-1,0.4),   ylim=c(0,1),      maxVary = 5)
#
#
# # Unrestricted Sample Size with lag of remaining outcomes
# plot(amShifted, "n",                 alertK = 50,     xlim=c(-1,0.4),   ylim=c(0,801), maxVary = 10, sizeRestrictions = "lag")
# plot(amShifted, "stopInconclusive",  alertK = 50,     xlim=c(-1,0.4),   ylim=c(0,1),   maxVary = 10, sizeRestrictions = "lag")
# plot(amShifted, "stopInconclusive",  waitWidth = 0.3, xlim=c(-1,0.4),   ylim=c(0,1),   maxVary = 10, sizeRestrictions = "lag")
#
...
#               maxN = 200, lagOutcomeN = 50))
#
# system.time(amShifted2 <- locationShift(am2, shiftedThetas = seq(-2,0.8,by=0.4)))
#
#
#
# # Unrestricted Sample Size
