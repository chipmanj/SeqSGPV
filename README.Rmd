...
1. The estimated success probability was XX (95\% credible interval: [lo, hi]) which is evidence that the treatment effect is at least trivially better than the null hypothesis (SGPV$_{ROWPE}$ = 0) and is evidence to reject the null hypothesis (SGPV$_{NULL}$ = 0).

2. The estimated success probability was XX (95\% credible interval: [lo, hi]) which is evidence that the treatment effect is not clinically meaningful (SGPV$_{ROME}$ = 0).

3. The estimated success probability was XX (95\% credible interval: [lo, hi]), which is suggestive though inconclusive evidence to rule out at essentially null effects (SGPV$_{ROWPE}$ = XX) yet is evidence to reject the null hypothesis (SGPV$_{NULL}$ = 0).

4. The estimated treatment effect was XX (95\% confidence interval: [lo, hi]) which is insufficient evidence to rule out any of essentially null effects (SGPV$_{ROWPE}$ = 0), clinically meaningful effects (SGPV$_{ROME}$ = 0), nor the null hypothesis effects (SGPV$_{XX}$ = 0).
...
1. The estimated treatment effect was XX (95\% confidence interval: [lo, hi]) which is evidence that the treatment effect is at least trivially better than the null hypothesis (SGPV$_{ROWPE}$ = 0) and is evidence to reject the null hypothesis (SGPV$_{NULL}$ = 0).

2. The estimated treatment effect was XX (95\% confidence interval: [lo, hi]) which is evidence that the treatment effect is not clinically meaningful (SGPV$_{ROME}$ = 0).

3. The estimated treatment effect was XX (95\% confidence interval: [lo, hi]), which is suggestive though inconclusive evidence to rule out at essentially null effects (SGPV$_{ROWPE}$ = XX) yet is evidence to reject the null hypothesis (SGPV$_{NULL}$ = 0).

4. The estimated treatment effect was XX (95\% confidence interval: [lo, hi]) which is insufficient evidence to rule out any of essentially null effects (SGPV$_{ROWPE}$ = 0), clinically meaningful effects (SGPV$_{ROME}$ = 0), nor the null hypothesis effects (SGPV$_{NULL}$ = XX).
