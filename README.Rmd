...
system.time(amShifted <- locationShift(am, shiftedThetas = seq(-0.2, 1, by = 0.1)))

# Unrestricted Sample Size
# Explore wait width (first with alert k specified at 50)
plot(amShifted, "n",                 alertK = 20,      xlim=c(-1, 1),   ylim=c(0,500))
plot(amShifted, "n",                 alertK = 20,      xlim=c(-1, 1),   ylim=c(0,500))
plot(amShifted, "rejPN",             alertK = 20,      xlim=c(-1, 1),   ylim=c(0,1))
plot(amShifted, "bias",              alertK = 20,      xlim=c(-1, 1),   ylim=c(-0.1,0.1))
plot(amShifted, "mse",               alertK = 20,      xlim=c(-1, 1),   ylim=c(0,0.1))
plot(amShifted, "cover",             alertK = 20,      xlim=c(-1, 1),   ylim=c(0.75,1))
plot(amShifted, "stopInconclusive",  alertK = 20,      xlim=c(-1, 1),   ylim=c(0,1))
plot(amShifted, "stopNotImpactful",  alertK = 20,      xlim=c(-1, 1),   ylim=c(0,1))
plot(amShifted, "stopNotTrivial",    alertK = 20,      xlim=c(-1, 1),   ylim=c(0,1))

# Explore number of steps in affirmation step
plot(amShifted, "n",                 waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(0,500))
plot(amShifted, "bias",              waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(-0.1,0.1))
plot(amShifted, "mse",               waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(0,0.1))
plot(amShifted, "cover",             waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(0.75,1))
plot(amShifted, "stopInconclusive",  waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(0,1))
plot(amShifted, "stopNotImpactful",  waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(0,1))
plot(amShifted, "stopNotTrivial",    waitWidth = 0.275,  xlim=c(-1, 1),   ylim=c(0,1))


# Unrestricted Sample Size with lag of remaining outcomes
plot(amShifted, "n",                 alertK = 10,     xlim=c(-1,1),   ylim=c(0,500), sizeRestrictions = "lag")
plot(amShifted, "stopInconclusive",  alertK = 10,     xlim=c(-1,1),   ylim=c(0,1),   sizeRestrictions = "lag")
plot(amShifted, "stopInconclusive",  waitWidth = 0.275, xlim=c(-1,1),   ylim=c(0,1), sizeRestrictions = "lag")

# Max N with immediate outcomes
plot(amShifted, "n",     alertK = 10,     xlim=c(-1,1),   ylim=c(0,500), sizeRestrictions = "maxN")
plot(amShifted, "stopInconclusive",     alertK = 10,     xlim=c(-1,1),   ylim=c(0,1), sizeRestrictions = "maxN")
...
# Unrestricted Sample Size
# Explore wait width (first with alert k specified at 50)
plot(amShifted2, "n",                 alertK = 0,  xlim=c(-2,2),   ylim=c(0,1500))
...
plot(amShifted2, "n",                waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(0,500))
plot(amShifted2, "bias",             waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(-0.1,0.1))
plot(amShifted2, "mse",              waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(0,0.3))
plot(amShifted2, "cover",            waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(0.75,1))
plot(amShifted2, "stopInconclusive", waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(0,1))  
plot(amShifted2, "stopNotImpactful", waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(0,1))  
plot(amShifted2, "stopNotTrivial",   waitWidth = 0.55,  xlim=c(-2,2),   ylim=c(0,1))


# Unrestricted Sample Size with lag of remaining outcomes
plot(amShifted2, "stopInconclusive",  alertK = 50,     xlim=c(-2,1),   ylim=c(0,1),  sizeRestrictions = "lag")
plot(amShifted2, "stopInconclusive",  waitWidth = 0.55, xlim=c(-2,1),   ylim=c(0,1),  sizeRestrictions = "lag")
plot(amShifted2, "stopInconclusive",  waitWidth = 0.55, xlim=c(-2,1),   ylim=c(0,1),  sizeRestrictions = "lag")
