...
Wait time until monitoring: Current recommendations for wait time are based upon the minimum sample size to achieve an expected minimum 95% confidence interval width under an assumed outcome's standard deviation.  This has optimal properties for reducing the Type I Error.  This assumes a working knowledge of the outcome's variability.  Further work involves using the estimated variability and to allow for wider confidence interval widths when the effect is further away from the Clinically Trivial and Highly Actionable Bounds.
