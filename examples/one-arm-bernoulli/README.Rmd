...
number of observations between assessments (steps from 1 to 5) and requiring a
...
We may be interested in the impact upon average sample size for these same changes to monitoring frequency.
...
With a minimal increase in average sample size, $S=1, A=1$ controls Type I error for all $W$ considered.
...
Back to PRISM SeqSGPV, we would want to know the operating characteristics of PRISM design across a range of effects.
...
```{r, fig.align='center', fig.height=10, fig.width=7,eval=TRUE}
par(mfrow=c(3,2))
